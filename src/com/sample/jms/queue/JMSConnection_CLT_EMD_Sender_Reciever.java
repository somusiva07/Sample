...
public class JMSConnection_CLT_EMD_Sender_Reciever {
public static void main(String args[]){
	...
	//ustlssoat180.airservices.svcs.entsvcs.net
		...
		try
        {
            ...
            Queue queue = session.createQueue("queue://TEMD01/TST.CLT.EMD.RQ.EMD.INITIATED.TG?targetClient=1");
            MessageProducer mp = session.createProducer(queue);
            
            String  edifactMessage = "Test Message from CLT";
            ...
            Queue res = session.createQueue("queue://TEMD01/TST.CLT.EMD.RS.EMD.INITIATED.TG?targetClient=1");
