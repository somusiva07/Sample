...
public static void main(String args[]){
	...
	//ustlssoat180.airservices.svcs.entsvcs.net
		...
		try
        {
            ...
            connection.start();
            Queue res = session.createQueue("queue://TEMD01/TST.TUL.EMD.RQ.EMD.TYPEA.TG?targetClient=1");
            ...
            Queue queue = session.createQueue("queue://TEMD01/TST.TUL.EMD.RS.EMD.TYPEA.TG?targetClient=1");
