...
public class JMSConnection_TUL_TypeA_Reciever_Sender {
public static void main(String args[]){
	...
	//ustlssoat180.airservices.svcs.entsvcs.net
		...
		try
        {
            ...
            connection.start();
            Queue res = session.createQueue("queue://TEMD01/TST.TUL.EMD.RQ.EMD.TYPEA.TB?targetClient=1");
            ...
            Queue queue = session.createQueue("queue://TEMD01/TST.TUL.EMD.RS.EMD.TYPEA.TB?targetClient=1");
            MessageProducer mp = session.createProducer(queue);
            
            String  edifactMessage = "Test Message from TUL - TB";
