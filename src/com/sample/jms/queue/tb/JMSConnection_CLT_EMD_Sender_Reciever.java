...
public static void main(String args[]){
	...
	//ustlssoat180.airservices.svcs.entsvcs.net
		...
		try
        {
            ...
            Queue queue = session.createQueue("queue://TEMD01/TST.CLT.EMD.RQ.EMD.INITIATED.TB?targetClient=1");
            ...
            Queue res = session.createQueue("queue://TEMD01/TST.CLT.EMD.RS.EMD.INITIATED.TB?targetClient=1");
