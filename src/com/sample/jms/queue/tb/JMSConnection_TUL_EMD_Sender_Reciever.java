...
public static void main(String args[]){
	...
	//ustlssoat180.airservices.svcs.entsvcs.net
		...
		try
        {
            ...
            Queue queue = session.createQueue("queue://TEMD01/TST.TUL.EMD.RQ.EMD.INITIATED.TB?targetClient=1");
            ...
            Queue res = session.createQueue("queue://TEMD01/TST.TUL.EMD.RS.EMD.INITIATED.TB?targetClient=1");
